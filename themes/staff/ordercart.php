...
<head>
<title>Online & Mobile Ordering system</title>
...
<div data-role="page" id="localiza">
	...
	<h5> ONLINE ORDER DELIVERLY SYSTEM</h5>
        </div>
...
<input type="hidden" name="command" />
    ...
    <input type="button" class="btn btn-info" value="ADD ANOTHER ORDER" onClick="window.location='orderproduct.php'"  class="table-condensed"/>
		...
		<table  align="center" border="0" class="table-condensed"  cellpadding="13px" cellspacing="1px" style="font-family:Arial; font-size:16px;  width="800%">
