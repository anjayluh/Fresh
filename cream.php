...
<body>
  ...
  $('.arrow-right').on('click', function(e){
    ...
    mySwiper.swipeNext()
	 ...
	 <h4 >  <a href="orderproduct.php" data-role="button" rel="external" data-theme="f">All Available Products</a> </h4>			
...
<div align="center">
	...
	<table border="0" cellpadding="2px" width="600px">
		<?php
		$cream=("cream");
			$result=mysql_query("select * from reyansproduct where category='$cream'");
