                    ...
                    <div class="span10">
                        ...
                        <div class="hero-unit-table">   
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-condensed" id="example">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysql_query("select * from reyansproduct") or die(mysql_error());
                                    while ($row = mysql_fetch_array($query)) {
                                        ...
                                        <tr class="warning">
                                            ...
                                            <td width="50" align="center"><img src="<?php echo $row['picture']; ?>" class="img-rounded" width="50" height="40"></td> 
                                            <td width="160">
                                    ...
                                    <div id="userdel<?php echo $user_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-danger">Are you Sure you Want to <strong>Delete &nbsp;</strong> <?php echo $row['product']; ?>?</div>
                                        </div>
